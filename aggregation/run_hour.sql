...
CREATE TABLE csv_sink (
            ...
            'connector' = 'filesystem',
            'format' = 'csv',
            'path' = '/home/karthik/work/flink/csv/output/run_fb.csv'
        );
...
INSERT INTO csv_sink SELECT * FROM
    csv_sink_hour_view;
...
CREATE VIEW IF NOT EXISTS v3
    AS
SELECT 
    name,device_id,tag,CEIL(agg_ts TO MONTH) as agg_ts,run_time
FROM 
    csv_sink_hour_view;
...
CREATE TABLE csv_sink_monthly (
            ...
            'connector' = 'filesystem',
            'format' = 'csv',
            'path' = '/home/karthik/work/flink/csv/output/run_fb-monthly.csv');
