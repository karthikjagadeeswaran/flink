...
def func():
    ...
    table_env.execute_sql(source_query_1)
    ...
    """
    table_env.execute_sql(source_query_2)
    # create and initiate loading of source Table
    tbl1 = table_env.from_path('KafkaTable1')
    tbl2 = table_env.from_path('KafkaTable2')
    ...
    agg.execute_insert('sinkKafka').wait()
