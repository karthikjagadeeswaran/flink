...
def func():
    ...
    postgresql_jar = os.path.join(os.path.abspath(os.path.dirname(__file__)),
                            'postgresql-42.3.1.jar'
                            )

    db_jar = os.path.join(os.path.abspath(os.path.dirname(__file__)),
                            'flink-connector-jdbc_2.11-1.13.6.jar'
                            )

    table_env.get_config()\
            .get_configuration()\
            .set_string("pipeline.jars", "file://{};file://{};file://{}".format(kafka_jar,db_jar,postgresql_jar))
    ...
    agg.execute_insert('sinkDB').wait()
